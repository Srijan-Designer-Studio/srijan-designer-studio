      ...
      <section className="bg-[#fcf8f6] py-16 px-4 sm:px-8 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {bridalProducts.map((product) => (
            <div key={product.id} className="flex flex-col items-center text-center bg-white border border-gray-100/60 p-6 rounded-sm shadow-sm hover:shadow-md transition-all duration-300">
