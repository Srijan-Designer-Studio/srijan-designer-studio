...
export default function ProductDetails({ product }) {
  ...
  const gtmViewItemTriggered = useRef(false);
  ...
  useEffect(() => {
    if (product && !gtmViewItemTriggered.current) {
      ...
      gtmViewItemTriggered.current = true;
    }
    ...
    <>
              ...
              {availableSizes.length > 0 && (
                <div className="prod-info mb-8">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="text-[16px] font-bold text-black">Size</h3>
                    
                    {sizeChartImage && (
                       <button 
                         onClick={() => setIsSizeChartOpen(true)}
                         className="text-[14px] font-semibold text-[#00c3ff] hover:underline cursor-pointer transition-colors"
                       >
                         Size Chart
                       </button>
                    )}
      ...
      {isSizeChartOpen && sizeChartImage && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity">
          <div className="relative bg-white w-full max-w-[800px] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto bg-[#f8f9fa] flex items-center justify-center">
              <img 
                src={sizeChartImage} 
                alt="Size Chart" 
