  ...
  return (
    <div className="animate-in text-black fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8 border-b border-gray-100 pb-5">
        ...
        <p className="text-[13px] text-gray-500 mt-1">Configure package dimensions, weight, and delivery options.</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-4 bg-gray-50 p-5 rounded-xl border border-gray-200">
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <div>
              <p className="text-[13px] font-bold text-gray-800">Cash on Delivery (COD)</p>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <div>
              <p className="text-[13px] font-bold text-gray-800">Free Shipping</p>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <div>
              <p className="text-[13px] font-bold text-gray-800">Return Eligible</p>
