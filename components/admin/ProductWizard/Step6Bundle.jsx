  ...
  return (
    <div className="animate-in text-black fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8 border-b border-gray-100 pb-5">
        ...
        <p className="text-[13px] text-gray-500 mt-1">Configure components if this product is sold as a set or bundle.</p>
      </div>
      ...
      {formData.purchaseType !== "Single Product" ? (
          ...
          <div className="p-5">
            {formData.components.length > 0 ? (
              ...
              <div className="text-center py-8">
                <p className="text-[13px] text-gray-500 font-medium">No components added yet.</p>
                <button 
                  onClick={addComponent}
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 text-center">
          ...
          <p className="text-[13px] text-gray-500 max-w-md mx-auto">This product will be sold as a single unit. No additional bundle components or set options are required.</p>
        </div>
      )}
    </div>
  );
