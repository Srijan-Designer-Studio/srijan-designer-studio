...
export default function DesignProcess() {
  return (
    <>
      <section className="py-16 bg-gradient-to-br from-[#8b91a5] to-[#4b5563] text-white">
        <div className="max-w-[1320px] mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6">How to Design<br />your Own Dress</h2>
          ...
          <div className="relative w-full aspect-video rounded-xl overflow-hidden border-[6px] border-gray-900 bg-black">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1320px] mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-black mb-12">How Does It Work ?</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-[#2c2b50] to-[#5d5b8d] text-white">
        <div className="max-w-[1320px] mx-auto px-6">
          <h2 className="text-3xl font-bold mb-4">Dresses Designed by Real Designer</h2>
          <p className="mb-10 text-gray-300 max-w-3xl">From dream sketches to finished outfits, discover how our designers create custom dresses that match every style, occasion and personality perfectly.</p>
