  ...
  const collections = [
    {
      ...
      placeholderBg: "bg-[#2dd4bf]", 
      imageSrc: ethnicCover, 
      link: "/ethnic-wear"   
    },
    {
      id: 2,
      buttonText: "Shop Western Wear",
      placeholderBg: "bg-[#38bdf8]", 
      imageSrc: westernCover, 
      link: "/western-wear"
    },
    {
      id: 3,
      buttonText: "Shop New Arrival",
      placeholderBg: "bg-[#fb7185]", 
      imageSrc: newArrivalCover, 
      link: "/new-arrivals"
    },
  ];

  return (
    <section className="py-20 lg:py-28 bg-gradient-to-b from-[#0e0c29] via-[#1a1b41] to-[#8f90a6]">
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {collections.map((item) => (
            <Link href={item.link} key={item.id} className="block"> {/* কার্ডগুলোকে ক্লিকেবল করে দিলাম */}
