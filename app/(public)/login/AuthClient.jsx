  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#121433] via-[#3d4563] to-[#8d94a6] p-6 overflow-hidden relative">
      ...
      <div className="relative w-full max-w-[1000px] h-[850px] md:h-[650px] bg-white/10 backdrop-blur-xl border border-white/20 rounded-[32px] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] overflow-hidden flex">
        ...
        <div className={`absolute top-0 left-0 w-full md:w-1/2 h-full p-8 md:p-14 flex flex-col justify-center transition-all duration-700 ease-in-out z-20 ${isLogin ? 'opacity-0 pointer-events-none -translate-x-full md:translate-x-0' : 'opacity-100 pointer-events-auto translate-x-0 md:translate-x-[100%]'}`}>
          ...
          {isOtpStep ? (
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-yellow-400 text-[13px] drop-shadow-sm">Code sent to {registeredEmail}</p>
              </div>

              <form onSubmit={handleVerifyOtp} className="space-y-5">
                <div className="relative">
                  <span className="absolute -top-3 left-4 bg-black/30 backdrop-blur-md px-2 py-0.5 rounded text-[11px] font-bold text-[#0ba6ff] border border-white/10 shadow-sm z-10">8-Digit OTP</span>
                  <div className="flex items-center border border-white/30 hover:border-[#0ba6ff]/70 focus-within:border-[#0ba6ff] rounded-xl px-4 py-3 bg-white/10 backdrop-blur-md transition-all">
                    ...
                    <input
                      ...
                      required
                      maxLength={8}
                      className="w-full bg-transparent outline-none text-[18px] text-center text-white font-mono tracking-[0.5em] placeholder:text-white/40 placeholder:tracking-normal"
                      placeholder="••••••••"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-4 pt-2">
                  <button disabled={isPending} type="submit" className="w-full flex justify-center items-center gap-2 cursor-pointer bg-[#00C3FF] hover:bg-[#00baef] text-white font-bold text-[13px] py-3.5 rounded-xl transition-all shadow-[0_0_15px_rgba(34,197,94,0.4)] hover:shadow-[0_0_25px_rgba(34,197,94,0.6)] uppercase tracking-wide disabled:opacity-70">
                  ...
                  <button type="button" onClick={() => setIsOtpStep(false)} className="w-full cursor-pointer flex items-center justify-center gap-3 bg-white/10 border border-white/30 hover:bg-white hover:text-black text-white font-bold text-[13px] py-3 rounded-xl transition-all uppercase tracking-wide group">
                    <ArrowLeft size={18} />
                    Back to Register
                  </button>
                </div>
            ...
            <>
              ...
              <form action={handleRegister} className="space-y-5">
                <div className="flex gap-4">
                  <div className="relative w-1/2">
                    ...
                    <div className="flex items-center border border-white/30 hover:border-[#0ba6ff]/70 focus-within:border-[#0ba6ff] rounded-xl px-4 py-3 bg-white/10 backdrop-blur-md transition-all">
                      ...
                      <input name="firstName" type="text" required className="w-full bg-transparent outline-none text-[14px] text-white font-medium placeholder:text-white/40" />
                    </div>
                  </div>
                  <div className="relative w-1/2">
                    ...
                    <div className="flex items-center border border-white/30 hover:border-[#0ba6ff]/70 focus-within:border-[#0ba6ff] rounded-xl px-4 py-3 bg-white/10 backdrop-blur-md transition-all">
                      <input name="lastName" type="text" required className="w-full bg-transparent outline-none text-[14px] text-white font-medium placeholder:text-white/40" />
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center border border-white/30 hover:border-[#0ba6ff]/70 focus-within:border-[#0ba6ff] rounded-xl px-4 py-3 bg-white/10 backdrop-blur-md transition-all">
                    ...
                    <input name="email" type="email" required className="w-full bg-transparent outline-none text-[14px] text-white font-medium placeholder:text-white/40" />
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center border border-white/30 hover:border-[#0ba6ff]/70 focus-within:border-[#0ba6ff] rounded-xl px-4 py-3 bg-white/10 backdrop-blur-md transition-all">
                    <Lock className="text-white/80 mr-3 shrink-0" size={18} />
                    <input name="password" type={showRegisterPassword ? "text" : "password"} minLength="6" required className="w-full bg-transparent outline-none text-[14px] text-white font-medium tracking-widest placeholder:text-white/40" />
              ...
              <div className="mt-8 text-center text-[13px] md:hidden">
                ...
                <button onClick={() => { setIsLogin(true); setIsOtpStep(false); }} className="font-extrabold text-white hover:text-[#0ba6ff] transition-colors drop-shadow-md ml-1 cursor-pointer">
                  Login Now
                </button>
              </div>
            </>
