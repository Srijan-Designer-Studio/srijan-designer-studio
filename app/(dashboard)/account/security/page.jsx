  ...
  return (
    <div className="max-w-3xl pt-[100px] lg:pt-[120px] space-y-6 font-sans">
      ...
      <div>
        ...
        <p className="text-[19px] text-gray-500 mt-1">Update your password and secure your account.</p>
      </div>
      ...
      <Card className="shadow-sm border-gray-100 p-0 overflow-hidden">
        <div className="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[19px] text-gray-500">Ensure your account is using a long, random password to stay secure.</p>
          </div>
        </div>
