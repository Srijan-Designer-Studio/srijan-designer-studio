  ...
  return (
    <div className="max-w-3xl pt-[100px] text-black lg:pt-[120px] mx-auto space-y-6 px-4 sm:px-0">
      ...
      <div>
        ...
        <p className="text-[19px] text-gray-500 mt-1">Enter your Order ID to get real-time delivery updates.</p>
      </div>
      ...
      {trackingData && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex flex-wrap gap-6 justify-between items-center">
            <div>
              <p className="text-[19px] text-gray-500 font-medium mb-1">Order Number</p>
              <h3 className="text-lg font-bold text-gray-900">#{trackingData.id}</h3>
            </div>
            <div>
              <p className="text-[19px] text-gray-500 font-medium mb-1">Estimated Delivery</p>
              <p className="text-gray-900 font-semibold flex items-center gap-2">
                <Clock size={16} className="text-[#0ba6ff]" /> {trackingData.estimatedDelivery}
              </p>
            </div>
            <div>
              <p className="text-[19px] text-gray-500 font-medium mb-1">Courier Partner</p>
              <p className="text-gray-900 font-semibold flex items-center gap-2">
          ...
          <div className="bg-blue-50/50 px-6 py-4 flex items-center gap-3 border-b border-blue-100/50">
            ...
            <div>
              <p className="text-[19px] font-semibold text-blue-900">Order is {trackingData.status}</p>
              <p className="text-[19px] text-blue-700 flex items-center gap-1 mt-0.5">
              ...
              <div className="relative">
                {trackingData.steps.map((step, index) => (
                  <div key={index} className="flex gap-4 sm:gap-6 mb-8 last:mb-0 relative">
                    ...
                    <div className={`relative z-10 w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center shrink-0 border-2 ${step.completed
